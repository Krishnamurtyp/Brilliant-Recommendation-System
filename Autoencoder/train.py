...
tf.app.flags.DEFINE_string('tf_records_train_path',
                           os.path.abspath(os.path.join(os.path.dirname("__file__"), '.', 'data/raw/tf_records/train/')),
                           'Path of the training data.')

tf.app.flags.DEFINE_string('tf_records_test_path',
                           os.path.abspath(os.path.join(os.path.dirname("__file__"), '.', 'data/raw/tf_records/test/')),
